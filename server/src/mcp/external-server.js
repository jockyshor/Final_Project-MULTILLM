...
server.tool('get_system_metrics', 'Get real-time host operating system statistics, CPU architecture, free RAM, memory usage percentage, and system uptime.', {}, async () => {
...
server.tool('fetch_webpage', 'Safely fetch any external HTTP/HTTPS URL and extract cleaned text content for analysis.', {
